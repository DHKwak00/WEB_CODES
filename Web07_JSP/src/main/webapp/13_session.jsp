...
<%--
	* HTTP 특성
	 ...
	 - 쿠키와 세션은 HTTTP 특성이 아닌 연결 상태를 유지하기 위해 사용
	 
	* 세션(session)
	 - 쿠키를 기반으로 사용
	 - 서버 측에서 데이터를 관리
	 - 세션 ID를 부여하여 브라우저를 종료할 때까지 데이터를 유지
	 - 세션 객체 : 사용자를 식별할 수 있는 방법을 제공, 사용자에 대한 정보 저장
	 - 주의사항 : 세션은 현재 프로젝트(클라이언트)에 실행되는 모든 웹 페이지에 적용됨
 ...
 --%>
	...
	<a href="13_session_test.jsp">13_session_test.jsp 페이지로 이동</a>
</body>
</html>