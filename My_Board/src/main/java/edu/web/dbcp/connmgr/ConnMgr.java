...
public class ConnMgr {
	...
	public static Connection getConnection() throws Exception {
		...
		Context initContext = new InitialContext(); // Context를 불러오는 메소드 ** Context가 있어야 불러오지
		Context envContext = (Context) initContext.lookup("java:comp/env");
		DataSource ds = (DataSource) envContext.lookup("dbcp/orcl"); // context.xml의 name과 동일해야한다.
